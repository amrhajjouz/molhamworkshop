    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 20; $i++) {
            $campaign = Campaign::create([
                'name' => getRandomArabicWords(rand(2,6)),
            ...
            $campaign->target->updateContentFields($contents);
            $campaign->target->update(['published_at' => date('Y-m-d H:i:s' , rand(strtotime('2021-01-01'), time()))]);
        }
    }
}
