...
class CreateProgramsScholarshipsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('programs_scholarships', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('programs_scholarships');
    }
}
