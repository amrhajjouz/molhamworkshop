...
=======
    <link rel="stylesheet" href="{{ asset('css/theme-rtl.css') }}" id="styleMode">
...
<body class="d-flex align-items-center cursor-wait" ng-class="{'cursor-wait' : $page.loading || $page.sendingHttpRequest}">
    ...
    <div class="modal fade" id="image-lightbox-modal" tabindex="-1" role="dialog"
        ...
        <a href="javascript:;" class="modal-dismiss-icon display-4" data-bs-dismiss="modal"><i
                class="fe fe-x"></i></a>
...
=======
    ...
    <script src="{{ asset('js/theme.js?v=5') }}"></script>
   <!-- <script src="{{ asset('js/custom.js') }}"></script> -->
    ...
    <script>
        ...
        app.directive('modalTitle', function() {
            ...
            return {
                ...
                replace: true,
                template: '<div class="modal-header"><h4 class="modal-title" ng-transclude></h4><button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>',
            };
        });
        ...
        app.directive('dropdown', function($rootScope, $page) {
            ...
            return {
                ...
                scope: {},
                replace: true,
                template: '<div class="dropdown"><a href="javascript:;" class="color-black mr-2" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fe fe-more-vertical"></i></a><div class="dropdown-menu" ng-transclude></div></div>',
            };
        });
