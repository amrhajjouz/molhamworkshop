...
<body dir="rtl" class="d-flex align-items-center cursor-wait" ng-class="{'cursor-wait' : $page.loading || $page.sendingHttpRequest}">
    ...
    <script>
        ...
        app.factory('$swal', function($page) {
        ...
        app.factory('$swalConfirm', function($apiRequest, $swal) {
            return function (title, text, path, params = {}) {
                Swal.fire({
                    title,
                    text,
                    icon: 'warning',
        ...
        app.factory('$swalConfirmWithInput', function($apiRequest, $swal) {
            return function (title, text, path, params = {}) {
                Swal.fire({
                    title: title,
                    text: text,
