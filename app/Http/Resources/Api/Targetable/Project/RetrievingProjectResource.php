...
class RetrievingProjectResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "liked_by_auth" => $donor ? $donor->likes()->where(['likeable_type' => 'project' , 'likeable_id' => $this->id])->exists() : false,
            "funded_by_auth" => $faker->boolean(), //TEMPORARY
            "saved_by_auth" => $donor ? $donor->savedItems()->where(['saveable_type' => 'project' , 'saveable_id' => $this->id])->exists() : false,
